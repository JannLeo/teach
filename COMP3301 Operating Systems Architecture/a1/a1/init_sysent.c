...
const struct sysent sysent[] = {
        ...
        { 2, s(struct sys_zone_info_args), SY_NOLOCK | 0,
            sys_zone_info },                    /* 335 = zone_info */
        { 1, s(struct sys_zone_id_args), SY_NOLOCK | 0,
            sys_zone_id },                      /* 336 = zone_id */
        { 2, s(struct sys_zone_chown_args), SY_NOLOCK | 0,
            sys_zone_chown },                   /* 337 = zone_chown */
        { 2, s(struct sys_zone_chgrp_args), SY_NOLOCK | 0,
            sys_zone_chgrp },                   /* 338 = zone_chgrp */
};